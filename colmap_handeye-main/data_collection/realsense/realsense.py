...
class Camera:
    ...
    #
    #             if not color_frame or not depth_frame:
    #                 print(f"Attempt {attempt + 1}: No frames received from camera {self.serial_number}")
    #                 continue
    #
    #             color_image = np.asanyarray(color_frame.get_data())
    #             depth_image = np.asanyarray(depth_frame.get_data())
    ...
    #                 print("Max retries reached. Could not get frames.")
    #                 return None, None
    #             continue
    #
    #     return None, None
    ...
    def get_pointcloud(self, depth_trunc):
        ...
        print('rgb_intrinsics:', rgb_intrinsics)
        print('rgb_coeffs:', rgb_coeffs)
        print('depth_intrinsics:', depth_intrinsics)
        print('depth_coeffs:', depth_coeffs)
